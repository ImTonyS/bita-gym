    ...
    <div className="bg-bita-dark">
      <main>
        ...
        <div className="isolate overflow-hidden">
          <div className="flow-root bg-bita-dark py-16 sm:pt-32 lg:pb-20">
                ...
                >
                  ...
                  <defs>
                    <radialGradient id="d25c25d4-6d43-4bf9-b9ac-1842a30a4867">
                      <stop stopColor="#a8d037" />
                      <stop offset={1} stopColor="#a8d037" />
                    </radialGradient>
                  </defs>
                </svg>
                <div
                  className="lg:absolute lg:inset-x-px lg:bottom-0 lg:top-4 lg:block lg:rounded-t-2xl lg:bg-gray-800/80 lg:ring-1 lg:ring-white/10"
                  aria-hidden="true"
                />
