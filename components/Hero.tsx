...
<div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
    <div>
      <h1 className="block text-3xl font-bold text-white sm:text-4xl lg:text-6xl lg:leading-tight">Transforma tu <span className="text-bita-green">cuerpo <strong className="text-white text-3xl">y</strong> mente</span>  </h1>
      <p className="mt-3 text-lg text-gray-800 dark:text-neutral-400">Sé parte del gimnasio más grande y equipado de la ciudad.</p>
      {/* Buttons */}
      <div className="mt-7 grid gap-3 w-full sm:inline-flex">
        <a className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-bita-green text-white hover:bg-bita-black disabled:opacity-50 disabled:pointer-events-none" href="#">
          Conoce tu club
