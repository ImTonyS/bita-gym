      ...
      <footer className="mx-auto mt-auto w-full max-w-[85rem] px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center gap-5 sm:grid sm:grid-cols-1 md:grid-cols-3">
          ...
          <ul className="text-center">
            <li className="relative inline-block pe-8 before:absolute before:end-3 before:top-1/2 before:-translate-y-1/2 before:text-gray-300 before:content-['/'] last:pe-0 last-of-type:before:hidden">
              <a
                className="inline-flex gap-x-2 text-sm text-zinc-50 hover:text-gray-200"
                href="/"
              >
                Inicio
              </a>
